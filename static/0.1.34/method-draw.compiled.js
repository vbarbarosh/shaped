...
;
// src/static/lib/js-hotkeys/jquery.hotkeys.min.js
﻿/*
...
// src/static/icons/jquery.svgicons.js
﻿/*
 * SVG Icon Loader 2.0
 *
...
// src/static/lib/jgraduate/jquery.jgraduate.js
﻿/*
 * jGraduate 0.4
 *
...
// src/static/lib/contextmenu/jquery.contextMenu.js
...
var supportsGoodTextCharPos_ = (function() {
   ...
   var pos = ff_bug_NS_ERROR_FAILURE(function () {
       return text.getStartPositionOfChar(0);
   }, 0);
...
var supportsPathBBox_ = (function() {
  ...
  var bbox = ff_bug_NS_ERROR_FAILURE_getBBox(path);
...
var supportsHVLineContainerBBox_ = (function() {
  ...
  var bbox = ff_bug_NS_ERROR_FAILURE_getBBox(g);
  document.documentElement.removeChild(svgcontent);
...
;
// src/static/src/svgtransformlist.js
/**
 * SVGTransformList
 *
 * Licensed under the Apache License, Version 2
...
(function() {
  ...
  if(!window.methodDraw) window.methodDraw = function($) {
    ...
    curConfig = {
      ...
      initOpacity: 1,
      imgPath: static_path('images/'),
      extPath: static_path('extensions/'),
      jGraduatePath: static_path('lib/jgraduate/images/'),
      extensions: [],
      initTool: 'select',
      wireframe: false,
...
//        var opacity = (picker == 'stroke' ? $('#stroke_opacity') : $('#fill_opacity'));
      ...
      setTimeout(function() {
        svgCanvas.embedImage(static_path('images/placeholder.svg'), function(datauri) {
          if(!datauri) {
            // Disable option
...
// src/static/lib/jquery-draginput.js
...
;
// src/static/lib/jquery-ui/jquery-ui-1.8.17.custom.min.js
/*!
 * jQuery UI 1.8.17
 *
...
// src/static/lib/jgraduate/jpicker.min.js
﻿/*
 * jPicker 1.1.6
 *
      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="' + tt('Click To Open Color Picker') + '">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
            ...
            initialize =
              function()
              {
                ...
                var controlHtml='<table class="jPicker" cellpadding="0" cellspacing="0">' +
                    ...
                    '<tr><td rowspan="9">' +
                      '<h2 class="Title">' + (win.title || localization.text.title) + '</h2>' +
                        '<div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><img src="' + images.clientPath + images.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="9"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span><img src="' + images.clientPath + images.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview">' +
                        '<div class="prev_div">' + localization.text.newColor + '<div class="color_preview"><span class="Active" title="' + localization.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + localization.tooltips.colors.currentColor + '">&nbsp;</span></div></div>' + localization.text.currentColor + '</td><td rowspan="9" class="Button"><input type="button" class="Ok" value="' + localization.text.ok + '" title="' + localization.tooltips.buttons.ok + '"/><input type="button" class="Cancel" value="' + localization.text.cancel + '" title="' + localization.tooltips.buttons.cancel + '"/><div class="Grid">&nbsp;</div></td></tr>' +
                    '<tr class="Hue"><td class="Radio"><label title="' + localization.tooltips.hue.radio + '"><input type="radio" value="h"' + (settings.color.mode == 'h' ? ' checked="checked"' : '') + '/><span></span>H:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.h : '') + '" title="' + localization.tooltips.hue.textbox + '"/>&nbsp;º</td></tr>' +
                    '<tr class="Saturation"><td class="Radio"><label title="' + localization.tooltips.saturation.radio + '"><input type="radio" value="s"' + (settings.color.mode == 's' ? ' checked="checked"' : '') + '/><span></span>S:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.s : '') + '" title="' + localization.tooltips.saturation.textbox + '"/>&nbsp;%</td></tr>' +
                    '<tr class="Value"><td class="Radio"><label title="' + localization.tooltips.value.radio + '"><input type="radio" value="v"' + (settings.color.mode == 'v' ? ' checked="checked"' : '') + '/><span></span>V:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.v : '') + '" title="' + localization.tooltips.value.textbox + '"/>&nbsp;%<br/><br/></td></tr>' +
                    '<tr class="Red"><td class="Radio"><label title="' + localization.tooltips.red.radio + '"><input type="radio" value="r"' + (settings.color.mode == 'r' ? ' checked="checked"' : '') + '/><span></span>R:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.r : '') + '" title="' + localization.tooltips.red.textbox + '"/></td></tr>' +
                    '<tr class="Green"><td class="Radio"><label title="' + localization.tooltips.green.radio + '"><input type="radio" value="g"' + (settings.color.mode == 'g' ? ' checked="checked"' : '') + '/><span></span>G:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.g : '') + '" title="' + localization.tooltips.green.textbox + '"/></td></tr>' +
                    '<tr class="Blue"><td class="Radio"><label title="' + localization.tooltips.blue.radio + '"><input type="radio" value="b"' + (settings.color.mode == 'b' ? ' checked="checked"' : '') + '/><span></span>B:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.b : '') + '" title="' + localization.tooltips.blue.textbox + '"/></td></tr>' +
                    '<tr class="Alpha"><td class="Radio">' + (win.alphaSupport ? '<label title="' + localization.tooltips.alpha.radio + '"><input type="radio" value="a"' + (settings.color.mode == 'a' ? ' checked="checked"' : '') + '/><span></span>A:</label>' : '&nbsp;') + '</td><td class="Text">' + (win.alphaSupport ? '<input type="text" maxlength="' + (3 + win.alphaPrecision) + '" value="' + (all != null ? Math.precision((all.a * 100) / 255, win.alphaPrecision) : '') + '" title="' + localization.tooltips.alpha.textbox + '"/>&nbsp;%' : '&nbsp;') + '</td></tr>' +
                    '<tr class="Hex"><td colspan="2" class="Text"><label title="' + localization.tooltips.hex.textbox + '">#:<input type="text" maxlength="6" class="Hex" value="' + (all != null ? all.hex : '') + '"/></label>' + (win.alphaSupport ? '<input type="text" maxlength="2" class="AHex" value="' + (all != null ? all.ahex.substring(6) : '') + '" title="' + localization.tooltips.hex.alpha + '"/></td>' : '&nbsp;') + '</tr>' +
                    '</tbody></table>';
                if (win.expandable)
                {
      ...
      color:
        {
          ...
          quickList: /* the quick pick color list */
            [
              new Color({hex: '#dffd8b'}),
              new Color({hex: '#73b025'}),
              new Color({hex: '#b2fcfd'}),
              new Color({hex: '#ffffff'}),
              new Color({hex: '#e38bfc'}),
              new Color({hex: '#44ade7'}),
              new Color({hex: '#1e9697'}),
              new Color({hex: '#fd9b1e'})
/*
      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            title: tt('Drag Markers To Pick A Color'),
            newColor: tt('new color'),
            currentColor: tt('current color'),
            ok: tt('OK'),
            cancel: tt('Cancel')
          },
          tooltips:
          {
            colors:
            {
              newColor: tt('New Color - Press &ldquo;OK&rdquo; To Commit'),
              currentColor: tt('Click To Revert To Original Color')
            },
            buttons:
            {
              ok: tt('Commit To This Color Selection'),
              cancel: tt('Cancel And Revert To Original Color')
            },
            hue:
            {
              radio: tt('Set To &ldquo;Hue&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Hue&rdquo; Value (0-360&deg;)')
            },
            saturation:
            {
              radio: tt('Set To &ldquo;Saturation&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Saturation&rdquo; Value (0-100%)')
            },
            value:
            {
              radio: tt('Set To &ldquo;Value&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Value&rdquo; Value (0-100%)')
            },
            red:
            {
              radio: tt('Set To &ldquo;Red&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Red&rdquo; Value (0-255)')
            },
            green:
            {
              radio: tt('Set To &ldquo;Green&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Green&rdquo; Value (0-255)')
            },
            blue:
            {
              radio: tt('Set To &ldquo;Blue&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Blue&rdquo; Value (0-255)')
            },
            alpha:
            {
              radio: tt('Set To &ldquo;Alpha&rdquo; Color Mode'),
              textbox: tt('Enter A &ldquo;Alpha&rdquo; Value (0-100)')
            },
            hex:
            {
              textbox: tt('Enter A &ldquo;Hex&rdquo; Color Value (#000000-#ffffff)'),
              alpha: tt('Enter A &ldquo;Alpha&rdquo; Value (#00-#ff)')
            }
          }
        }
    };
})(jQuery, '1.1.6');;
// src/static/lib/mousewheel.js
...
// src/static/extensions/ext-eyedropper.js
/*
 * ext-eyedropper.js
 *
 * Licensed under the Apache License, Version 2
...
methodDraw.addExtension("eyedropper", function(S) {
    ...
    return {
      name: "eyedropper",
      svgicons: static_path('extensions/eyedropper-icon-iconsflow.xml'),
      buttons: [{
        id: "tool_eyedropper",
        type: "mode",
        title: tt('Eye Dropper Tool'),
        position: 8,
        key: "I",
        icon: static_path('extensions/eyedropper.png'),
        events: {
          "click": function() {
            svgCanvas.setMode("eyedropper");
          }
...
;
// src/static/extensions/ext-grid.js
/*
 * ext-grid.js
 *
 * Licensed under the Apache License, Version 2
...
;
// src/static/extensions/ext-shapes.js
/*
 * ext-shapes.js
 *
 * Licensed under the Apache License, Version 2
...
methodDraw.addExtension("shapes", function() {
  ...
  function loadLibrary(cat_id) {
    ...
    if(!lib) {
      ...
      $.getJSON(static_path('extensions/shapelib/' + cat_id + '.json'), function(result, textStatus) {
  ...
  return {
    svgicons: static_path('extensions/ext-shapes.xml'),
    buttons: [{
      id: "tool_shapelib",
      type: "mode_flyout", // _flyout
      position: 6,
      title: "Shape library",
      icon: static_path('extensions/ext-shapes.png'),
      events: {
        "click": function() {
...
;
// src/static/lib/requestanimationframe.js
(function() {
    var lastTime = 0;
